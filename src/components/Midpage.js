...
import mid from "../images/bg4.png";
    ...
    return (
        <div>
            <section>
                        ...
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    ...
                                    Forget just IT professionals - we're your digital architects, bridging the gap between your dreams and reality. We
                                    craft bespoke solutions, from stunning websites to robust applications, all designed to deliver results.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                ...
                <img src={mid}  className="w-10/12 h-1/2 justify-center mx-auto" alt="img" />
            </section>
        </div>
    )
}
